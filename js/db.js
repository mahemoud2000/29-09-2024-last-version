...
// عرض المنتجات
window.showProducts = function showProducts() {
    showLoader();
...
// عرض المنتجات
window.displayProducts = function displayProducts(snapshot) {
...
// // عرض التقارير
// window.showReports = function showReports() {
//     showLoader();
...
window.deleteSale = function deleteSale(saleId) {
...
window.deleteReport = function deleteReport(reportId) {
...
document.getElementById('searchInput2').addEventListener('input', searchProduct);
